...
class AgentState(TypedDict, total=False):
    ...
    # ── Agentic mode (AGENTIC=true) — planner-executor loop in
    # agent/orchestrator_agent.py. Unused by the legacy fixed graph. ──
    messages: list              # running LLM message history (tool-calling loop)
    _pending_tool_calls: list   # tool calls emitted this turn, consumed by tools_node
    coding_model: str           # optional override for the CODING_MODEL role
